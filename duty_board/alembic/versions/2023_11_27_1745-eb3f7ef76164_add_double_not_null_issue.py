...
def upgrade() -> None:
    ...
    op.create_check_constraint("user_email_not_both_none", "person", "NOT(username IS NULL AND email IS NULL)")
    op.create_unique_constraint("username_email_unique", "person", ["username", "email"])


def downgrade() -> None:
    op.drop_constraint("username_email_unique", "person", type_="unique")
    op.drop_constraint("user_email_not_both_none", "person", type_="check")
    # ### commands auto generated by Alembic - please adjust! ###
