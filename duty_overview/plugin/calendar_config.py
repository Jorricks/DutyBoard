...
class DutyCalendarConfig:
    ...
    order: int = field(default=999, validator=[validators.instance_of(int), validators.ge(0), validators.lt(9999999)])
    ...
    prefix: str | None = field(validator=validators.optional([validators.instance_of(str), validators.max_len(50)]))
